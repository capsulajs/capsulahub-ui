...
import { Paragraph, Logs, Modal, Button, JsonInput, Input, CheckBox, Dropdown, Loader } from '../components';
...
const App = () => (
  <Container>
    <Paragraph fontSize="3rem" color="#3F3F3F" backgroundColor={backgroundColor}>
      CapsulaJS UI components
    </Paragraph>
    <Block style={{ height: 500, paddingBottom: 125 }}>
      <Paragraph fontSize="1.5rem" color="#3F3F3F" backgroundColor={backgroundColor}>
        - Catalog:
      </Paragraph>
      <CatalogExample />
    </Block>
    ...
    <Block>
      ...
      <Modal id="modal" title="Some title...">
        Some content...
      </Modal>
    </Block>
    <Block>
