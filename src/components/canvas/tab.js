...
export default class Tab extends React.Component {
  ...
  renderContent() {
    ...
    return (
      <Title data-cy={isActive ? `canvas-tab-${tab.id}-title-active` : `canvas-tab-${tab.id}-title`} isActive={isActive} onClick={this.onSelect} onDoubleClick={this.onDoubleClick}>
        {tab.name}
      </Title>
    );
  }
