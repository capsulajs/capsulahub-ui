...
var Container = _styledComponents.default.div(_templateObject(), _constants.defaultFontFamily, _constants.defaultFontWeight, _constants.defaultFomtSize);
...
var JsonInput = function JsonInput(_ref) {
  ...
  }, _react.default.createElement(Header, null, _react.default.createElement(Image, {
    src: _settings.default
  }), _react.default.createElement(Title, null, "JSON Input")), _react.default.createElement(_reactAce.default, {
    mode: "json",
    theme: "capsula-js",
    value: value,
    onChange: onChange,
