...
function (_React$Component) {
  ...
  _createClass(D, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement(Title, null, Number.isInteger(selected) ? items[selected].label : title), isOpen ? _react.default.createElement(ArrowUp, null) : _react.default.createElement(ArrowDown, null)), isOpen && _react.default.createElement(List, null, items.map(function (item, index) {
