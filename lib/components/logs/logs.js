...
var Row = function Row(_ref) {
  ...
  if (item.status === 'fail') {
    content = _react.default.createElement(FlexRow, null, _react.default.createElement(Timestamp, null, (0, _utils.decorate)(item.timestamp) + ' | '), _react.default.createElement(Button, {
      onClick: onResend
    }, " Resend"));
  }
  ...
  return _react.default.createElement(FlexRow, null, _react.default.createElement(RowPoint, null, item.status === 'fail' && _react.default.createElement(Point, null)), _react.default.createElement(RowNumber, null, number), _react.default.createElement(RowTimestamp, null, (0, _utils.decorate)(item.timestamp)), _react.default.createElement(RowContent, null, content));
};
...
var Logs = function Logs(_ref2) {
  var data = _ref2.data,
      ...
      path = _ref2.path;
  return _react.default.createElement(Container, null, _react.default.createElement(Header, null, _react.default.createElement(FlexRow, null, _react.default.createElement(Image, {
    src: _settings.default
  }), _react.default.createElement(Title, null, "LOG")), onClear && _react.default.createElement(Clear, {
    onClick: onClear
  }, "\u2715")), _react.default.createElement(Content, null, data ? data.map(function (item, index) {
  ...
  }) : _react.default.createElement("div", null, "No Data..")), _react.default.createElement(Footer, null, path));
};
