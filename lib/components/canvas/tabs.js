...
function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function renderDraggable(tab, index) {
      ...
      return _react.default.createElement(_reactBeautifulDnd.Draggable, {
        ...
        return _react.default.createElement("div", _extends({
          ...
          onUpdate: onUpdate
        }), isRemovable && _react.default.createElement(Close, {
    ...
    value: function render() {
      ...
      return _react.default.createElement(Container, null, _react.default.createElement(_reactBeautifulDnd.Droppable, {
        ...
        return _react.default.createElement("div", _extends({
          ref: provided.innerRef,
          style: getListStyle()
        }, provided.droppableProps), _this3.props.tabs.map(function (tab, index) {
