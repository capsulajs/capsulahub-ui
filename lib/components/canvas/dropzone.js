...
var Centre = _styledComponents.default.div(_templateObject3(), function (props) {
...
function (_React$Component) {
  ...
  _createClass(Dropzone, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _dropzone.isSmall)(container) && this.setState({
        ratio: 1
      });
      this.onDrag$ = (0, _rxjs.fromEvent)(container, 'dragover').pipe((0, _operators.map)(function (e) {
        return e.preventDefault() || [e.clientX, e.clientY];
      }), (0, _operators.distinctUntilChanged)(function (a, b) {
        return a.toString() === b.toString();
      }), (0, _operators.throttleTime)(50), (0, _operators.map)(function (point) {
        var _document;

        var value = (_document = document).elementFromPoint.apply(_document, _toConsumableArray(point)).classList.value;
      ...
      var pipes = [(0, _operators.map)(function (e) {
        return e.preventDefault() || e.fromElement;
      }), (0, _operators.filter)(Boolean), (0, _operators.map)(function (element) {
        return !element.classList.value.includes('sector');
      }), (0, _operators.filter)(Boolean)];
      this.onDragEnter$ = (_fromEvent = (0, _rxjs.fromEvent)(container, 'dragenter')).pipe.apply(_fromEvent, pipes).subscribe(function (_) {
        return _this2.state.ratio === 1 && _this2.setState({
          sectors: _constants.SECTORS
        });
      });
      this.onDragLeave$ = (_fromEvent2 = (0, _rxjs.fromEvent)(container, 'dragleave')).pipe.apply(_fromEvent2, pipes).subscribe(function (_) {
        return _this2.setState({
          sectors: []
        });
      });
      this.onDrop$ = (0, _rxjs.fromEvent)(container, 'drop').pipe((0, _operators.map)(function (e) {
        return e.dataTransfer.getData('builderId');
      })).subscribe(function (builderId) {
        return builderId ? _this2.props.onDrop({
          builderId: builderId,
    ...
    value: function render() {
      ...
      return _react.default.createElement(Container, null, _react.default.createElement(Centre, {
