  ...
  _createClass(Grid, [{
    ...
    value: function handleOnDrop(node) {
      ...
      return function (_ref) {
        ...
        if (node.type !== 'container') {
          _this2.props.onUpdate((0, _create.default)({
    ...
    value: function handleOnRemove(node) {
      ...
      return function (tabId) {
        return _this3.props.onUpdate((0, _remove.default)({
    ...
    value: function renderNode(node, key) {
      ...
      if (type === 'container') {
        return _react.default.createElement(_reactReflex.ReflexElement, {
          key: key,
      ...
      }, tabs.length ? _react.default.createElement(_content.default, {
        id: node.id,
        tabs: tabs,
        builders: builders,
    ...
    value: function renderNodes(nodes, orientation) {
      ...
      var reduce = function reduce(acc, node, idx) {
        ...
        return idx > 0 ? [].concat(_toConsumableArray(acc), [splitter, n]) : [].concat(_toConsumableArray(acc), [n]);
      };

      return _react.default.createElement(_reactReflex.ReflexContainer, {
